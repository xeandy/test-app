...
class FocusedMenuHolder1 extends StatefulWidget {
  final Widget child;
  ...
  @override
  _FocusedMenuHolder1State createState() => _FocusedMenuHolder1State();
}

class _FocusedMenuHolder1State extends State<FocusedMenuHolder1> {
