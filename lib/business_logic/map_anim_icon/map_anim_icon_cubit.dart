...
part 'map_anim_icon_state.dart';
part 'map_anim_icon_cubit.freezed.dart';

@injectable
class MapAnimIconCubit extends Cubit<MapAnimIconState> {
  MapAnimIconCubit() : super(MapAnimIconState.initial());
