...
// ignore: unused_element
  _LoadFailure loadFailure(FirestoreFailure categoryFailure) {
    return _LoadFailure(
      categoryFailure,
    );
  }
...
mixin _$CategoryWatcherState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loadFailure(FirestoreFailure categoryFailure),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    ...
    TResult loadFailure(FirestoreFailure categoryFailure),
...
abstract class _$LoadFailureCopyWith<$Res> {
  ...
  $Res call({FirestoreFailure categoryFailure});
...
abstract class _LoadFailure implements CategoryWatcherState {
  const factory _LoadFailure(FirestoreFailure categoryFailure) = _$_LoadFailure;
